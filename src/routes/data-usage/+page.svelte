<script lang="ts">
	...
	// Components
	import DataUsage from '$lib/components/legal-pages/DataUsage.svelte';
...
<svelte:head>
	...
	/>
	<meta name="keywords" content={$translationsStore.legalPages.dataUsage.dataUsageMetaKeywords} />
