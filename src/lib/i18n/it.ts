export const it = {
	...
	generalTexts: {
		...
		buildProfileSaveBuiltUserSectionParagraph2: 'Controlla le informazioni prima di salvare. Una volta completato, potrai modificare il tuo profilo ogni volta che vuoi.',
