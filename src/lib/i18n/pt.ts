export const pt = {
	...
	musicCommunityPage: {
		...
		publicUser: {
			...
			musicCommunityPageMetaKeywords: 'perfil público, perfil de usuário, comunidade musical, artistas mais ouvidos, músicas mais ouvidas, comentários de usuários, Allify',
