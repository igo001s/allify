export const ru = {
	...
	musicArchivePage: {
		...
		musicArchivePageParagraph1: 'Здесь вы можете исследовать артистов и песни, которые уже были частью вашего музыкального пути в Allify. Мы знаем, что каждая песня имеет свою историю, и хотим помочь вам вновь пережить эти воспоминания.'
	},
	musicCommunityPage: {
