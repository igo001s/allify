	...
	legalPages: {
		privacyPolicy: {
			...
			privacyPolicyDiv6Paragraph2:
				'Платежи обрабатываются сторонними платежными провайдерами, такими как AbacatePay. Allify не собирает и не хранит полные данные банковских карт или другую конфиденциальную финансовую информацию.',
