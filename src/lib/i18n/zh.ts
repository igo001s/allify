export const zh = {
	...
	profilePage: {
		...
		profilePageMetaOgAndTwitterContent:
			'查看您的公开个人资料，分享您的收听统计、喜欢的歌曲、播放列表和已保存的专辑，并连接您的流媒体平台以获取个性化洞察。',
		profilePageImageAltText: '的个人资料照片',
		...
		profilePageYourSongsOnProfileHeading3v2: '此刻的歌曲',
		profilePageYourSongsOnProfileEditMusicIconAriaLabel: '编辑此刻歌曲的按钮',
		profilePageYourSongsOnProfileEditCustomMusicIconAriaLabel: '编辑自定义歌曲的按钮',
		...
		profilePageChangeYourMusicCloseModalAriaLabel: '关闭更改此刻歌曲的弹窗',
		profilePageChangeYourMusicCloseModalAltText: '关闭更改此刻歌曲弹窗的图标',
		profilePageChangeYourMusicParagraph1: '更新您个人资料中的此刻歌曲',
		profilePageChangeYourMusicParagraph2: '选择最能代表您现在正在聆听内容的歌曲。',
		profilePageChangeYourMusicChooseMusicAriaLabel: '为个人资料选择此刻歌曲',
		profilePageChangeYourMusicTimeToNextFreeUpdate: '您可以免费更新于',
		profilePageChangeYourMusicUnlockMoreMusic: '继续解锁更多歌曲，进一步个性化您的个人资料。',
		profilePageChangeYourCustomMusicCloseModalAriaLabel: '关闭更改自定义歌曲的弹窗',
		profilePageChangeYourCustomMusicCloseModalAltText: '关闭更改自定义歌曲弹窗的图标',
		profilePageChangeYourCustomMusicTitleInputLabel: '为您的歌曲命名',
		profilePageChangeYourCustomMusicTitleInputPlaceholder: '例如：我人生的原声带',
		profilePageChangeYourCustomMusicUnlockMoreMusic: '继续解锁更多歌曲，进一步个性化您的个人资料。',
		profilePageEmptyMusicOfTheMomentHeading1: '此刻的歌曲',
		profilePageEmptyMusicOfTheMomentAltText: '此刻歌曲选择图标',
		profilePageEmptyMusicOfTheMomentHeading2: '选择此刻的歌曲',
		profilePageEmptyMusicOfTheMomentParagraph1:
			'选择最能代表您此刻状态的歌曲，并在个人资料中突出展示。',
		profilePageSelectYourMusicCloseModalAriaLabel: '关闭选择此刻歌曲的弹窗',
		profilePageSelectYourMusicCloseModalAltText: '关闭选择此刻歌曲弹窗的图标',
		profilePageSelectYourMusicParagraph1: '选择您的此刻歌曲',
		profilePageSelectYourMusicParagraph2: '选择最能代表您现在正在聆听内容的歌曲。',
		profilePageSelectYourMusicChooseMusicAriaLabel: '为个人资料选择此刻歌曲',
		profilePageSelectYourMusicChooseMusicFollowers: '位关注者',
		profilePageSelectYourMusicUnlockMoreMusic: '继续解锁更多歌曲，进一步个性化您的个人资料。',
		profilePageSelectYourCustomMusicTitleInputLabel: '为您的歌曲命名',
		profilePageSelectYourCustomMusicTitleInputPlaceholder: '例如：我人生的原声带',
		profilePageSelectYourCustomMusicCloseModalAriaLabel: '关闭选择自定义歌曲的弹窗',
		profilePageSelectYourCustomMusicCloseModalAltText: '关闭选择自定义歌曲弹窗的图标',
		profilePageSelectYourCustomMusicUnlockMoreMusic: '继续解锁更多歌曲，进一步个性化您的个人资料。',
		profilePageEmptyCustomMusicHeading1: '您的歌曲，由您定义',
		profilePageEmptyCustomMusicAltText: '自定义歌曲选择图标',
		profilePageEmptyCustomMusicHeading2: '赋予您的歌曲独特意义',
		profilePageEmptyCustomMusicParagraph1:
			'从您最常听的歌曲中选择一首，并按照自己的喜好自定义标题。',
		profilePageYourArtistsOnProfileHeading2: '您的音乐人',
		profilePageYourArtistsOnProfileHeading3v1: '最常听的音乐人',
		profilePageYourArtistsOnProfileHeading3v2: '此刻的音乐人',
		profilePageYourArtistsOnProfileFollowers: '位关注者',
		profilePageYourArtistsOnProfileEditArtistIconAriaLabel: '编辑此刻音乐人的按钮',
		profilePageYourArtistsOnProfileEditCustomArtistIconAriaLabel: '编辑自定义音乐人的按钮',
		profilePageYourArtistsOnProfileEditArtistIconAltText: '编辑此刻音乐人图标',
		profilePageChangeYourArtistCloseModalAltText: '关闭更改此刻音乐人弹窗的图标',
		profilePageYourArtistsOnProfileEditCustomArtistIconAltText: '编辑自定义音乐人图标',
		profilePageChangeYourArtistCloseModalAriaLabel: '关闭更改此刻音乐人的弹窗',
		profilePageChangeYourArtistParagraph1: '更新您个人资料中的此刻音乐人',
		profilePageChangeYourArtistParagraph2: '选择最能代表您现在正在聆听内容的音乐人。',
		profilePageChangeYourArtistChooseArtistAriaLabel: '为个人资料选择此刻音乐人',
		profilePageChangeYourArtistChooseArtistFollowers: '位关注者',
		profilePageChangeYourArtistTimeToNextFreeUpdate: '您可以免费更新于',
		profilePageChangeYourArtistUnlockMoreMusic: '继续解锁更多音乐人，进一步个性化您的个人资料。',
		profilePageChangeYourCustomArtistCloseModalAriaLabel: '关闭更改自定义音乐人的弹窗',
		profilePageChangeYourCustomArtistCloseModalAltText: '关闭更改自定义音乐人弹窗的图标',
		profilePageChangeYourCustomArtistTitleInputLabel: '为您的音乐人添加标题',
		profilePageChangeYourCustomArtistTitleInputPlaceholder: '例如：我最大的灵感来源',
		profilePageChangeYourCustomArtistUnlockMoreMusic:
			'继续解锁更多音乐人，进一步个性化您的个人资料。',
		profilePageEmptyArtistOfTheMomentHeading1: '此刻的音乐人',
		profilePageEmptyArtistOfTheMomentAltText: '此刻音乐人选择图标',
		profilePageEmptyArtistOfTheMomentHeading2: '选择此刻的音乐人',
		profilePageEmptyArtistOfTheMomentParagraph1:
			'选择最能代表您此刻状态的音乐人，并在个人资料中突出展示。',
		profilePageSelectYourArtistCloseModalAriaLabel: '关闭选择此刻音乐人的弹窗',
		profilePageSelectYourArtistCloseModalAltText: '关闭选择此刻音乐人弹窗的图标',
		profilePageSelectYourArtistParagraph1: '选择您的此刻音乐人',
		profilePageSelectYourArtistParagraph2: '选择最能代表您现在正在聆听内容的音乐人。',
		profilePageSelectYourArtistChooseArtistAriaLabel: '为个人资料选择此刻音乐人',
		profilePageSelectYourArtistChooseArtistFollowers: '位关注者',
		profilePageSelectYourArtistUnlockMoreMusic: '继续解锁更多音乐人，进一步个性化您的个人资料。',
		profilePageSelectYourCustomArtistCloseModalAriaLabel: '关闭选择自定义音乐人的弹窗',
		profilePageSelectYourCustomArtistCloseModalAltText: '关闭选择自定义音乐人弹窗的图标',
		profilePageSelectYourCustomArtistTitleInputLabel: '为您的音乐人添加标题',
		profilePageSelectYourCustomArtistTitleInputPlaceholder: '例如：我最大的灵感来源',
		profilePageSelectYourCustomArtistUnlockMoreMusic:
			'继续解锁更多音乐人，进一步个性化您的个人资料。',
		profilePageEmptyCustomArtistHeading1: '您的音乐人，由您定义',
		profilePageEmptyCustomArtistAltText: '自定义音乐人选择图标',
		profilePageEmptyCustomArtistHeading2: '赋予您的音乐人独特意义',
		profilePageEmptyCustomArtistParagraph1:
			'从您最常听的音乐人中选择一位，并按照自己的喜好自定义标题。',
		profilePageSelectYourCustomItemParagraph1: '由您定义',
		profilePageSelectYourCustomMusicParagraph2:
			'选择一首歌曲，并为它添加一个能够表达您此刻感受、经历或回忆的标题。',
		profilePageSelectYourCustomArtistParagraph2:
			'选择一位音乐人，并为其添加一个能够表达您此刻感受、经历或回忆的标题。',
		profilePageChangeYourCustomItemParagraph1: '按您的方式更新',
		profilePageChangeYourCustomArtistParagraph2:
			'选择另一位音乐人，并为其添加一个能够表达您此刻感受、经历或回忆的标题。',
		profilePageChangeYourCustomMusicParagraph2:
			'选择另一首歌曲，并为它添加一个能够表达您此刻感受、经历或回忆的标题。',
