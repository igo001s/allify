export const de = {
	...
	settingsPage: {
		...
		settingsPageProfileVisibilityChangeAgainSingularMessage: 'Du kannst die Sichtbarkeit deines Profils in <strong>{hours} Stunde</strong> erneut ändern.',
		...
		settingsPageProfileVisibilityChangeAgainAvailableMessage: 'Du kannst die Sichtbarkeit deines Profils jetzt erneut ändern.'
	},
	addTickets: {
