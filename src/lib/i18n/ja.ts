export const ja = {
	...
	profilePage: {
		...
		profilePageMetaDescription:
			'公開プロフィールを表示し、再生統計、お気に入りの楽曲、プレイリスト、保存したアルバムを共有しましょう。ストリーミングプラットフォームを連携すると、パーソナライズされたインサイトを確認できます。',
		profilePageMetaKeywords:
			'最も聴かれた音楽, 今の一曲, パーソナライズされた音楽, 最も聴かれたアーティスト, 今のアーティスト, パーソナライズされたアーティスト, 音楽プロフィール, 音楽統計, 音楽プロフィール, 音楽コミュニティ',
