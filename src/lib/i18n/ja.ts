export const ja = {
	...
	generalTexts: {
		...
		headerLanguagePtAltText: 'ポルトガル語の国旗',
		headerLanguageEn: '英語',
		headerLanguageEnAltText: '英語の国旗',
		headerLanguageEs: 'スペイン語',
		headerLanguageEsAltText: 'スペイン語の国旗',
		headerLanguageDe: 'ドイツ語',
		headerLanguageDeAltText: 'ドイツ語の国旗',
		headerLanguageFr: 'フランス語',
		headerLanguageFrAltText: 'フランス語の国旗',
		headerLanguageIt: 'イタリア語',
		headerLanguageItAltText: 'イタリア語の国旗',
		headerLanguageRu: 'ロシア語',
		headerLanguageRuAltText: 'ロシア語の国旗',
		...
		profileLoggedAltText: 'ユーザープロフィール写真',
	...
	homePage: {
		...
		homePageMetaDescription:
			'Allifyで音楽の個性を発見しましょう。ストリーミングサービスを連携し、よく聴くアーティストや楽曲を確認して、自分だけの音楽プロフィールを作成できます。',
	...
	myMusicalProfilePage: {
		...
		myMusicalProfilePagePeriodButtonOneYear: '過去1年',
		myMusicalProfilePagePeriodButtonSixMonths: '過去6か月',
		myMusicalProfilePagePeriodButtonFourWeeks: '過去4週間',
	...
	profilePage: {
		...
		profilePageWithoutLoginMetaDescription:
			'Allifyでプロフィールを作成し、音楽コミュニティで自分の音楽の好みを共有しましょう。ログインすると、プロフィールをカスタマイズして、再生統計、お気に入りの曲、プレイリスト、保存したアルバムを共有できます。',
		profilePageMetaKeywords:
			'音楽プロフィール, 音楽統計, 最もよく聴く曲, 今月の曲, カスタム曲, 最もよく聴くアーティスト, 今月のアーティスト, カスタムアーティスト, お気に入りの曲, プレイリスト, 保存したアルバム, 音楽コミュニティ, Allify',
		...
		profilePageSelectYourCustomMusicTitleInputErrorInvalidCharactersMessage:
			'タイトルには文字と数字のみを使用してください',
		profilePageSelectYourCustomMusicCloseModalAriaLabel: 'カスタム楽曲を選択するモーダルを閉じる',
		profilePageSelectYourCustomMusicCloseModalAltText:
			'カスタム楽曲を選択するモーダルを閉じるアイコン',
		...
		profilePageSelectYourCustomMusicParagraph2:
			'楽曲を選び、今感じていること、経験していること、思い出していることを表すタイトルを付けましょう。',
		profilePageSelectYourCustomArtistParagraph2:
			'アーティストを選び、今感じていること、経験していること、思い出していることを表すタイトルを付けましょう。',
		profilePageChangeYourCustomItemParagraph1: 'あなたらしく更新',
	...
	errorPage: {
		...
		errorPage404MetaDescription:
			'お探しのページが見つかりませんでした。削除されたか、アドレスが間違っている可能性があります。',
		errorPageOtherErrorsMetaDescription:
			'このページの読み込み中に問題が発生しました。しばらくしてからもう一度お試しください。',
		errorPage404MetaOgAndTwitterContent:
			'お探しのページが見つかりませんでした。削除されたか、アドレスが間違っている可能性があります。',
		errorPageOtherErrorsMetaOgAndTwitterContent:
			'このページの読み込み中に問題が発生しました。しばらくしてからもう一度お試しください。',
		errorPage404Heading1: 'ページが見つかりません',
		errorPage404Paragraph1:
			'お探しのページが見つかりませんでした。削除されたか、アドレスが間違っている可能性があります。',
		errorPageOtherErrorsHeading1: 'おっと！何かがうまくいきませんでした。',
		errorPageOtherErrorsParagraph1:
			'このページの読み込み中に問題が発生しました。しばらくしてからもう一度お試しください。',
		errorPageButtonGoHome: 'ホームページへ戻る'
	},
	legalPages: {
		privacyPolicy: {
		...
		dataUsage: {
			...
			dataUsageMetaDescription:
				'Allifyがお客様の音楽やアカウントに関連するデータをどのように収集、利用、処理しているか、また利用可能なセキュリティ対策や管理方法について説明します。',
			dataUsageMetaKeywords:
				'データ利用, データ収集, データ処理, Allify, 音楽インサイト, 再生統計, ユーザー情報, データプライバシー, データセキュリティ, ストリーミングサービス, Spotify, Deezer',
			dataUsageMetaOgAndTwitterContent:
				'Allifyがお客様の音楽やアカウントに関連するデータをどのように収集、利用、処理しているか、また利用可能なセキュリティ対策や管理方法について説明します。',
			dataUsageDiv1Heading1: 'データ利用について',
			dataUsageDiv1LastUpdated: '最終更新日：2026年8月25日',
			dataUsageDiv1Paragraph1:
				'このデータ利用ページでは、音楽インサイトプラットフォームであるAllifyを利用する際に、Allifyが情報をどのように収集、利用、処理、保護するかについて説明します。',
			dataUsageDiv2Heading2: '1. 利用するデータ',
			dataUsageDiv2Paragraph1:
				'Allifyは、対応するストリーミングサービスとの接続を通じてユーザーが許可したデータに加え、プラットフォームの運営に必要な技術データを利用します。',
			dataUsageDiv2Paragraph2:
				'これには、アカウント識別子、接続状態、許可されたAPIを通じて提供される音楽データ、サービスの運用や維持に必要な限定的な技術情報などが含まれる場合があります。',
			dataUsageDiv3Heading2: '2. データの利用方法',
			dataUsageDiv3Paragraph1:
				'データは、パーソナライズされた音楽インサイトの生成、再生統計の表示、機能のパーソナライズ、チケットシステムの管理、Allifyの正常な運用のために利用されます。',
			dataUsageDiv3Paragraph2:
				'また、内部分析、パフォーマンスの監視、問題の検出、プラットフォームの改善のために、集計または匿名化されたデータを利用する場合があります。',
			dataUsageDiv4Heading2: '3. データの処理と保存',
			dataUsageDiv4Paragraph1:
				'音楽データは主にAllifyの機能を提供するために処理され、該当する場合は、それらの機能の運用、維持、改善に必要な期間のみ保存されます。',
			dataUsageDiv4Paragraph2:
				'保存期間や保存方法は、データの種類、利用目的、サービスの運用に必要な要件によって異なる場合があります。',
			dataUsageDiv5Heading2: '4. データセキュリティ',
			dataUsageDiv5Paragraph1:
				'Allifyでは、不正アクセス、改ざん、不適切な開示、紛失、破壊からデータを保護するため、適切な技術的および組織的対策を講じています。',
			dataUsageDiv5Paragraph2:
				'Allifyが処理する情報を保護するためにセキュリティ対策を講じていますが、電子的な送信または保存に使用されるシステムや方法が完全に安全であることを保証することはできません。',
			dataUsageDiv6Heading2: '5. 第三者のサービスとAPI',
			dataUsageDiv6Paragraph1:
				'Allifyは、音楽ストリーミングプラットフォーム、ホスティング、インフラストラクチャ、認証、決済などの第三者が提供するAPIやサービスに依存しており、これらのサービスは独自のポリシーや規約に従ってデータを処理する場合があります。',
			dataUsageDiv6Paragraph2:
				'Allifyは、これらの第三者サービスによるプライバシー、セキュリティ、可用性、データ処理の実務を管理していません。データがどのように取り扱われるかを理解するため、それぞれのポリシーや規約を確認することをおすすめします。',
			dataUsageDiv7Heading2: '6. データの共有',
			dataUsageDiv7Paragraph1:
				'Allifyは、ユーザーの個人データを販売、貸与、または商業目的で提供することはありません。',
			dataUsageDiv7Paragraph2:
				'プラットフォームの運用、保護、維持、改善に必要なサービス提供者によって、一部のデータが処理または共有される場合があります。これらは適用される目的および法的要件に従って行われます。',
			dataUsageDiv8Heading2: '7. ユーザーによる管理',
			dataUsageDiv8Paragraph1:
				'ユーザーはストリーミングアカウントとの接続を管理でき、第三者サービスに付与した権限を、それらのサービスが提供する方法に従っていつでも取り消すことができます。',
			dataUsageDiv8Paragraph2:
				'該当する場合、ユーザーはAllifyのポリシーに記載された手続きおよび要件に従って、アカウントに関連付けられたデータの削除を依頼することもできます。',
			dataUsageDiv9Heading2: '8. プライバシーポリシーとの関係',
			dataUsageDiv9Paragraph1:
				'このページでは、Allifyにおけるデータの利用および処理について具体的に説明し、当社のプライバシーポリシーを補足しています。',
			dataUsageDiv9Paragraph2:
				'個人データの収集、利用、保存、保護、およびデータに関する権利について詳しくは、当社のプライバシーポリシーをご確認ください。'
		},
		termsOfService: {
			title: '利用規約 | Allify',
			termsOfServiceMetaDescription:
				'Allifyの利用規約をご確認ください。プラットフォームへのアクセスと利用に関するルール、ユーザーの責任、利用上の制限について説明しています。',
			termsOfServiceMetaOgAndTwitterContent:
				'Allifyの利用規約をご確認ください。プラットフォームへのアクセスと利用に関するルール、ユーザーの責任、利用上の制限について説明しています。',
			termsOfServiceMetaKeywords:
				'利用規約, 使用条件, Allify, 音楽インサイトプラットフォーム, 利用ポリシー, 権利と責任, プラットフォームへのアクセス, 行動規範, 責任制限',
			termsOfServiceDiv1Heading1: '利用規約',
			termsOfServiceDiv1LastUpdated: '最終更新日：2026年8月25日',
			termsOfServiceDiv1Paragraph1:
				'本利用規約は、Allifyプラットフォームへのアクセスおよびその利用について定めるものです。Allifyにアクセスまたは利用することにより、本規約に同意したものとみなされます。',
			termsOfServiceDiv2Heading2: '1. プラットフォームの利用',
			termsOfServiceDiv2Paragraph1:
				'Allifyは、Spotifyなどの第三者ストリーミングサービスやその他の対応サービスから、ユーザーが許可したデータに基づいて音楽に関するインサイトを提供するプラットフォームです。',
			termsOfServiceDiv2Paragraph2:
				'本規約に従い、合法的かつ個人的な目的でのみプラットフォームを利用するものとし、サービスの運営、安全性または完全性を悪用、乱用、侵害する行為を試みないことに同意するものとします。',
			termsOfServiceDiv3Heading2: '2. ユーザーの責任',
			termsOfServiceDiv3Paragraph1:
				'接続されたアカウント、付与した権限、およびストリーミングサービスのアカウントをプラットフォームに接続して利用する権限を有していることについて、ユーザー自身が責任を負います。',
			termsOfServiceDiv3Paragraph2:
				'Allifyを違法、悪用、詐欺、悪意のある自動化を伴う活動、または第三者サービスの規約、ポリシー、APIに違反する活動に利用しないことに同意するものとします。',
			termsOfServiceDiv4Heading2: '3. アカウントと利用終了',
			termsOfServiceDiv4Paragraph1:
				'ユーザーは、自身の認証情報の安全を維持し、Allifyアカウントを通じて行われる活動について責任を負います。',
			termsOfServiceDiv4Paragraph2:
				'プラットフォームで提供されている機能に従い、いつでもAllifyの利用を停止し、ストリーミングサービスのアカウントとの接続を解除できます。',
			termsOfServiceDiv4Paragraph3:
				'サービスまたはユーザーを保護するため、法的要件を遵守するため、または本利用規約への違反に対応するために必要な場合、当社はプラットフォームへのアクセスを制限、一時停止、または終了することがあります。',
			termsOfServiceDiv5Heading2: '4. 知的財産',
			termsOfServiceDiv5Paragraph1:
				'Allifyのブランド、名称、インターフェース、デザイン、コード、ビジュアル要素、およびその他の独自コンテンツは、適用される知的財産法によって保護されています。',
			termsOfServiceDiv5Paragraph2:
				'適用法で認められている場合を除き、事前の許可なくAllifyの要素をコピー、複製、変更、配布、商業利用、その他の方法で使用することはできません。',
			termsOfServiceDiv6Heading2: '5. サービスの可用性',
			termsOfServiceDiv6Paragraph1:
				'Allifyを利用可能かつ正常に機能する状態に維持するよう努めていますが、サービスが常に中断なく、安全かつエラーなく利用できることを保証するものではありません。',
			termsOfServiceDiv6Paragraph2:
				'メンテナンス、セキュリティ、技術的な改善、第三者サービスの変更、または法的要件への対応のため、機能を更新、変更、制限、または一時的に停止する場合があります。',
			termsOfServiceDiv7Heading2: '6. 責任の制限',
			termsOfServiceDiv7Paragraph1:
				'Allifyは、その利用可能性に基づいて提供され、音楽に関するインサイトを提供する情報およびエンターテインメントを目的としています。',
			termsOfServiceDiv7Paragraph2:
				'第三者のAPIまたはサービスによって提供されるデータの不正確さ、それらのサービスの中断や変更、またはAllifyが表示するインサイトに基づいて行われた判断について、当社は責任を負いません。',
			termsOfServiceDiv8Heading2: '7. 本規約の変更',
			termsOfServiceDiv8Paragraph1:
				'プラットフォーム、第三者との連携、利用可能な機能、または法的要件の変更を反映するため、本利用規約を随時更新する場合があります。',
			termsOfServiceDiv8Paragraph2:
				'重要な変更が行われた場合、このページに表示されている最終更新日を変更します。更新版の公開後もAllifyを継続して利用することで、改訂された規約に同意したものとみなされます。'
		}
	}
};
