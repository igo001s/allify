<script lang="ts">
	...
	// Services
	import { addToFavorites } from '$lib/services/user/add/addToFavorites';
...
<article
	class="flex h-fit w-full items-center justify-between rounded-lg border border-b-default bg-s-muted hover:border-brand-primary"
>
	<button
