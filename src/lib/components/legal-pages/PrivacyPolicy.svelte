...
<section class="legal-pages-spacing">
	...
	<div>
		...
		<p class="font-medium">
			{$translationsStore.legalPages.privacyPolicy.privacyPolicyDiv13Paragraph2}
		</p>
	</div>
</section>
