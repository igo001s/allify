<script lang="ts">
	...
	export let iconAriaLabel: string = $translationsStore.generalTexts.profileNotLoggedAltText;
</script>

<svg viewBox="0 0 24 24" class={iconSvgClass} aria-label={iconAriaLabel} role="img" fill="none">
	<path
		opacity="0.75"
